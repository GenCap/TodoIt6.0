...
namespace TodoItTests
{
    public class TodoItTests
    {
        ...
        {
            //Arrange
            Person testPerson = new Person("Zelda", "Gamer", PersonSequencer.NextPersonId());
        ...
        {
            //Arrange
            Person testPerson = new Person("Zelda", "Jonsson", PersonSequencer.NextPersonId());
        ...
        {
            // Arrange
            string firstName1 = "Zelda";
            string lastName1 = "Gamer";
            string firstName2 = "Marco";
            string lastName2 = "Gamer";
        ...
        public void TodoClassTest()
        {
            ...
            string description2 = "Run some code";
        ...
        public void FindPersonByIdTest()
        {
            //Arrange
            People testingPeople = new People();
            Person testPerson1 = testingPeople.CreateNewPerson("Fredrik", "Acholt");
        ...
        public void SizePersonTest()
        {
            //Assert
            People testingPeople = new People();
            testingPeople.CreateNewPerson("Johanna", "Asp");
        ...
        public void FindAllPeopleTest()
        {
            ...
            testingPeople.CreateNewPerson("Fredrik", "Alberg");
            testingPeople.CreateNewPerson("Lena", "Molin");
        ...
        public void RemovePersonTest()
        {
            ...
            Person testPerson1 = testPerson.CreateNewPerson("Sofia", "Berg");
            Person testPerson2 = testPerson.CreateNewPerson("Carl-Ludwig", "Hallberg");
            Person testPerson3 = testPerson.CreateNewPerson("Anna-Lena", "Larsson");
        ...
        public void CreateNewTodoTest()
        {
            ...
            string description3 = "Dog walk master";
        ...
        public void FindTodoByIdTest()
        {
            ...
            Todo testTodo1 = testingTodos.CreateNewTodo("Read code");
            Todo testTodo2 = testingTodos.CreateNewTodo("Go code");
        ...
        public void TodoSizeTest()
        {
            ...
            testingPeople.CreateNewPerson("Mona-Lisa", "Harddrive");
        ...
        public void FindAllTodosTest()
        {
            ...
            testingPeople.CreateNewPerson("Fred", "Lind");
            testingPeople.CreateNewPerson("William", "Windows");
            testingPeople.CreateNewPerson("Jens", "Schmidth");
            int expectedSize = 3;
            //Act
            Person[] foundPersons = testingPeople.FindAll();
        ...
        public void FindByDoneTest()
        {
            ...
            Todo todo1 = todoTest.CreateNewTodo("Run Exit");
            Todo todo2 = todoTest.CreateNewTodo("No rest for the wicked");
        ...
        public void TestFindByAssigneeId()
        {
            ...
            Todo todo1 = testTodos.CreateNewTodo("Wake up");
            Todo todo2 = testTodos.CreateNewTodo("Sleep");
            Todo todo3 = testTodos.CreateNewTodo("Finish the test");
            Todo todo4 = testTodos.CreateNewTodo("Have some coffee");
